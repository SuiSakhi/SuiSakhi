  ...
  Future<void> _loadTailors() async {
    try {
      ...
      final profileLoginEmails = profiles
          ...
          .whereType<String>()
          .toSet();
      final profileMobiles = profiles
          .map((p) => p['mobile'] as String?)
          .whereType<String>()
          .toSet();

      final orphanEmails = emails
          .where((e) => !profileLoginEmails.contains(e))
          .toList();
      final orphanPhones = phones
          .where((p) => !profileMobiles.contains(p))
          .toList();
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Manage your shop, tailors and pricing',
                  ...
                  itemBuilder: (_, i) {
                    ...
                    if (i < pc + po) {
                      ...
                      return ListTile(
                        ...
                        title: Text('Tailor', style: AppTextStyles.titleMedium),
                        subtitle: Text(
                          phone,
                          style: AppTextStyles.bodySmall.copyWith(fontSize: 12),
                        ),
  ...
  Widget _buildActionGrid(BuildContext context) {
    final actions = [
      ...
      (
        ...
        () => context.push('/owner/partner-applications'),
      ),
      (
        'Add Fashion Partner',
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    const Spacer(),
                    Text(
                      '${_deliveryEmails.length} enrolled',
                      style: AppTextStyles.bodySmall,
                    ),
                  ],
                ),
                ...
                if (_deliveryEmails.isEmpty)
                  Padding(
                    ...
                    child: Center(
                      child: Text(
                        'No delivery partners enrolled yet.',
                        style: AppTextStyles.bodyMedium,
                      ),
                    ),
                  )
                      ...
                      return ListTile(
                        ...
                        trailing: IconButton(
                          ...
                          onPressed: () async {
                            ...
                            await AppState.instance.removeDeliveryPartner(
                              email,
                            );
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              const Text(
                'Fee paid to delivery partner per order:',
                style: TextStyle(fontSize: 13),
              ),
              const SizedBox(height: 8),
              TextField(
              ...
              const SizedBox(height: 16),
              const Text(
                'Monthly subscription fee charged to partner:',
                style: TextStyle(fontSize: 13),
              ),
              const SizedBox(height: 8),
              TextField(
